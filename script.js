...
function SaveGameHistory() {
    localStorage.setItem("game-history", container.innerHTML)
}

function ShowGameHistory() {
    container.innerHTML = localStorage.getItem("game-history")
}
